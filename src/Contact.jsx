...
function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact | Aaronline Design</title>
        <meta
          name="description"
          content="Contact Aaronline Design in Brisbane for expert web design, website development, branding, and digital marketing services."
        />
        <link rel="canonical" href="https://aaronlinedesign.au/contact" />
      </Helmet>
      <section className="contact">
        <div className="col left">
          ...
          <p className="contact-subheading">
            ...
            questions, want to discuss a potential collaboration, or just want
